...
call conda install -y numpy==1.19.0 -c conda-forge
call conda install -y scikit-image -c conda-forge
call conda install -y python-blosc==1.7.0 -c conda-forge
call conda install -y pytorch==1.7.1 -c pytorch
call conda install -y torchvision -c pytorch
call conda install -y cudatoolkit=11.0 -c pytorch
